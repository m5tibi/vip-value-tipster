  ...
  const T = {
    ...
    hu: {
      ...
      index: {
        ...
        p3_body:        'Egy sima ChatGPT promptból hiányoznak a valós, friss adatok — és az sem tudod, hogyan kérdezd.',
        ...
        step1_p:        'A rendszer 37 liga közelgő meccseit figyeli folyamatosan. Minden meccsre lekéri a valós bookmaker oddsokat több fogadóirodától — hendikep, gólszám és győztes piacokon egyaránt.',
        ...
        step3_p:        'Minden AI-javaslatot admin ellenőriz, mielőtt megjelenne. A jóváhagyott tippek azonnal felkerülnek a weboldalra, és e-mailben értesítünk. Az eredményeket a rendszer automatikusan ellenőrzi és rögzíti.',
        ...
        f2_tag:         'Elemző oldal',
        f3_h:           'E-mail értesítések',
        f3_p:           'Minden jóváhagyott tippről azonnal e-mailt küldünk — nem maradsz le semmiről.',
        f3_tag:         'E-mail',
        ...
        faq3_a:         'Egy általános AI-nak nincs valós idejű hozzáférése a bookmaker oddsokhoz, a friss sérülési listákhoz és az aktuális forma-adatokhoz. A 90perc.hu rendszere pontosan ezeket gyűjti össze és adja az AI-nak — plusz az eredmények nyomon követése, Telegram integráció és az előzmény mind olyan réteg, amit egy sima chatbottal magadnak kellene felépíteni.',
        ...
        faq6_a:         '37 ligát és kupát folyamatosan — a Premier League-től a Bundesligán, La Ligán, Serie A-n és Ligue 1-en át egészen a Copa Libertadoresig, MLS-ig és a J1 League-ig.',
        cta_badge:      '✦ 14 990 Ft/hó · Bármikor lemondható',
        cta_h2:         'Próbáld ki.<br/><em>Nem kerül semmibe.</em>',
        cta_sub:        'Regisztrálj ingyen, és azonnal hozzáférsz az ingyenes napi tipphez és az elemzőhöz.',
        cta_btn1:       'Regisztrálok →',
        cta_tg:         'Telegram csatorna',
        feat_free_h:    'Ingyenes napi tipp',
        feat_free_p:    'Minden regisztrált felhasználó kap egy ingyenes tippet naponta — elemzéssel együtt. Előfizetés nélkül is.',
        feat_free_tag:  'Ingyenes',
      ...
      tips: {
        ...
        free_badge:       '🆓 Ingyenes napi tipp',
        free_tip_none:    'Ma még nincs ingyenes tipp.',
        free_tip_paywall: '🔒 A többi tipp előfizetőknek',
        free_tip_paywall_body: 'Az ingyenes napi tipptől a többi jóváhagyott tipphez előfizetés szükséges.',
        ...
        login_cta_title:    'Lépj be a tippekhez',
        login_cta_body:     'Regisztrálj ingyen és azonnal hozzáférsz az <b style="color:#a5d6a7">ingyenes napi tipphez</b> és az elemzőhöz.<br>A többi tipphez előfizetés szükséges.',
        closed:             'Lezárt',
        tips_word:          'tippek',
        paywall_body2:      'A napi tippek megtekintéséhez előfizetés kell.<br>Az eddigi eredmények az <b>Előzmények</b> fülön szabadon megtekinthetők.',
      },
      ...
      analyzer: {
        ...
        no_api_key:         'API kulcs hiányzik — add meg a Beállítások fülön',
        no_key_alert:       'Kérlek add meg a Claude API kulcsodat a Beállítások fülön!',
        team_example:       'Csapat1 - Csapat2;',
        analysis_failed:    'Elemzés sikertelen.',
    ...
    en: {
      ...
      index: {
        ...
        p3_body:        'A plain ChatGPT prompt lacks real, up-to-date data — and you wouldn\'t know how to ask the right questions either.',
        ...
        step1_p:        'The system continuously monitors upcoming matches from 37 leagues. For each match it fetches live bookmaker odds from multiple sources — across handicap, totals, and winner markets.',
        ...
        step3_p:        'Every AI suggestion is reviewed by an admin before going live. Approved tips appear on the website immediately, and you get an email notification. Results are automatically verified and recorded.',
        ...
        f3_h:           'Email Notifications',
        f3_p:           'You get an instant email for every approved tip — you never miss anything.',
        f3_tag:         'E-mail',
        ...
        faq6_a:         '37 leagues and cups continuously — from the Premier League, Bundesliga, La Liga, Serie A and Ligue 1 to the Copa Libertadores, MLS and J1 League.',
        cta_badge:      '✦ 14,990 HUF/month · Cancel anytime',
        cta_h2:         'Give it a try.<br/><em>It\'s free.</em>',
        cta_sub:        'Register for free and get instant access to the daily free tip and the match analyzer.',
        cta_btn1:       'Register →',
        cta_tg:         'Telegram channel',
        feat_free_h:    'Free daily tip',
        feat_free_p:    'Every registered user gets one free tip per day — with full analysis. No subscription needed.',
        feat_free_tag:  'Free',
      ...
      tips: {
        ...
        free_badge:       '🆓 Free daily tip',
        free_tip_none:    'No free tip yet today.',
        free_tip_paywall: '🔒 More tips for subscribers',
        free_tip_paywall_body: 'A subscription is required for all other approved tips.',
        ...
        login_cta_title:    'Sign in for tips',
        login_cta_body:     `Registration is <b style="color:#a5d6a7">free</b>, and you see today's tips immediately.<br>Preview our past results in the <b>History</b> tab.`,
        closed:             'Closed',
        tips_word:          'tips',
        paywall_body2:      'A subscription is needed to view daily tips.<br>Past results are freely viewable in the <b>History</b> tab.',
      },

      /* ── ANALYZER ── */
      analyzer: {
        title:          '90perc.hu – Match Analyzer',
        nav_sub:        'AI Match Analyzer',
        back:           '← Home',
        ...
        no_api_key:         'API key missing — add it in the Settings tab',
        no_key_alert:       'Please add your Claude API key in the Settings tab!',
        team_example:       'Team1 - Team2;',
